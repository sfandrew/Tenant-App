...
claridge_app.fields.build([
  ...
  { field_order: 99, name: "Prior Company/Job #2", field_type: "small_header", required: false, content_meta: "", included_in_report: false, field_width: "12"},
  { field_order: 100, name: "Company Name #2", field_type: "text_field", required: false, content_meta: "", included_in_report: false, field_width: "12"},
  { field_order: 101, name: "Company address #2", field_type: "text_field", required: false, content_meta: "", included_in_report: false, field_width: "12"},
  { field_order: 102, name: "City #2", field_type: "text_field", required: false, content_meta: "", included_in_report: false, field_width: "4"},
  { field_order: 103, name: "State #2", field_type: "text_field", required: false, content_meta: "", included_in_report: false, field_width: "4"},
  { field_order: 104, name: "Zip code #2", field_type: "text_field", required: false, content_meta: "", included_in_report: false, field_width: "4"},
  { field_order: 105, name: "Country #2", field_type: "text_field", required: false, content_meta: "", included_in_report: false, field_width: "6"},
  { field_order: 106, name: "Position #2", field_type: "text_field", required: false, content_meta: "", included_in_report: false, field_width: "6"},
  { field_order: 107, name: "Start date #2", field_type: "calendar", required: false, content_meta: "", included_in_report: false, field_width: "6"},
  { field_order: 108, name: "End date #2", field_type: "calendar", required: false, content_meta: "", included_in_report: false, field_width: "6"},
  { field_order: 109, name: "Supervisor name #2", field_type: "text_field", required: false, content_meta: "", included_in_report: false, field_width: "6"},
  { field_order: 110, name: "Supervisor phone #2", field_type: "phone_validation", required: false, content_meta: "", included_in_report: false, field_width: "6"},
  { field_order: 111, name: "Gross monthly salary #2", field_type: "currency", required: false, content_meta: "", included_in_report: false, field_width: "6"},
  { field_order: 113, name: "Attach secondary Pay Stub Month 1", field_type: "file_upload", required: false, content_meta: "", included_in_report: false, field_width: "6"},
  { field_order: 114, name: "Attach secondary Pay Stub Month 2", field_type: "file_upload", required: false, content_meta: "", included_in_report: false, field_width: "6"},
  { field_order: 125, name: "Student Info", field_type: "field_group", required: false, content_meta: "", included_in_report: false, field_width: "12"},
  { field_order: 137, name: "Name of Institution", field_type: "text_field", required: false, content_meta: "", included_in_report: false, field_width: "12"},
  { field_order: 138, name: "Address of Institution", field_type: "text_area", required: false, content_meta: "", included_in_report: false, field_width: "12"},
  { field_order: 139, name: "Start date", field_type: "calendar", required: false, content_meta: "", included_in_report: false, field_width: "6"},
  { field_order: 140, name: "Expected end date", field_type: "calendar", required: false, content_meta: "", included_in_report: false, field_width: "6"},
  { field_order: 141, name: "Course of study", field_type: "text_field", required: false, content_meta: "", included_in_report: false, field_width: "6"},
  { field_order: 142, name: "Degree sought", field_type: "text_field", required: false, content_meta: "", included_in_report: false, field_width: "6"},
  { field_order: 143, name: "Registrar Contact Name if any", field_type: "text_area", required: false, content_meta: "", included_in_report: false, field_width: "12"},
  { field_order: 144, name: "Registrar Main Tel #", field_type: "phone_validation", required: false, content_meta: "", included_in_report: false, field_width: "6"},
  { field_order: 145, name: "School document", field_type: "file_upload", required: false, content_meta: "", included_in_report: false, field_width: "6"},
  { field_order: 184, name: "Verification", field_type: "field_group", required: false, content_meta: "", included_in_report: false, field_width: "12"},
  { field_order: 185, name: "Do you have any civil judgment been entered against you in the past 10 years?", field_type: "options_select", required: true, content_meta: "No,Yes", included_in_report: false, field_width: "6"},
  { field_order: 186, name: "Do you have any water filled furniture or do you intend to get any water filled furniture?", field_type: "options_select", required: true, content_meta: "No,Yes", included_in_report: false, field_width: "6"},
  { field_order: 187, name: "Have you filed for bankruptcy in the past 10 years?", field_type: "options_select", required: true, content_meta: "No,Yes", included_in_report: false, field_width: "6"},
  { field_order: 188, name: "Have you ever been evicted or have you ever refused to pay rent for any reason?", field_type: "options_select", required: true, content_meta: "No,Yes", included_in_report: false, field_width: "6"},
  { field_order: 189, name: "Have you, or do you intend to , posses, sell or use illicit drugs or narcotics in your residence?", field_type: "options_select", required: true, content_meta: "No,Yes", included_in_report: false, field_width: "6"},
  { field_order: 190, name: "Have you ever lived here before or do you know anyone living here now or in the past?", field_type: "options_select", required: true, content_meta: "No,Yes", included_in_report: false, field_width: "6"},
  { field_order: 191, name: "If any of the questions above answered yes, please explain", field_type: "text_area", required: false, content_meta: "", included_in_report: false, field_width: "12"},
  { field_order: 192, name: "How did you hear about this vacancy?", field_type: "text_field", required: false, content_meta: "", included_in_report: false, field_width: "6"},
  { field_order: 193, name: "What made you decide to apply with us?", field_type: "text_field", required: false, content_meta: "", included_in_report: false, field_width: "6"},
  { field_order: 194, name: "Agreement", field_type: "field_group", required: false, content_meta: "", included_in_report: false, field_width: "12"},
  { field_order: 195, name: "Earnest Money Deposit", field_type: "small_header", required: false, content_meta: "", included_in_report: false, field_width: "12"},
  { field_order: 196, name: "", field_type: "long_description", required: false, content_meta: "A holding deposit puts you first in line for a specific unit while your application is being processed. Please submit a personal check, money order or cashiers check in the amount as stated and make the check payable to the building name. \r\nThe check can be mailed or dropped off in person at \r\n<address>\r\nPIP Inc<br>\r\n1201 Fulton Street<br>\r\nSan Francisco, CA 94117<br>\r\n</address>\r\n<ul>\r\n<li>Studio = $200</li>\r\n<li>1 Bed = $300</li>\r\n<li>2+ Bed= $400</li>\r\n</ul>\r\n\r\n", included_in_report: false, field_width: "12"},
  { field_order: 197, name: "Application Fee", field_type: "small_header", required: false, content_meta: "", included_in_report: false, field_width: "12"},
  { field_order: 198, name: "", field_type: "long_description", required: false, content_meta: "The $35 non-refundable application fee for each tenant and guarantor must be paid at the completion of this application. Your application will not fully complete once paid. You can pay for it on the view saved forms section on the top navigation link once you submit your application. One application fee covers up to 6 months of future applications for the same applicant.", included_in_report: false, field_width: "12"},
  { field_order: 199, name: "", field_type: "long_description", required: false, content_meta: "Is hereby given as surety for Applicant's promise to timely complete the Lease Application, and execute the Lease within 24 hours after notification of acceptance. It is specifically understood that the Earnest money is fully refundable if Lanlord/PIP/sfrent.net rejects the application and offer. Applicant understands and agrees that Landlord/PIP/sfrent.net will deposit the earnest money payment upon receipt and that if the applicant is rejected, Landlord/PIP/sfrent.net will not issue the refund until (10) business days have elapsed from the date of Landlord/PIP/sfrent.net deposit of the Earnest Money payment. The earnest money may be applied to part of the security deposit at execution of the Lease and payment of the move-in money. If Lanlord/PIP/sfrent.net ahs duly accepted this Application and offer, it is then treated as a completed contract to rent/lease the above described property and Applicant's attempted revocation shall be deemed a breach of contract. PLEASE NOTE: If this application and offer is revoked by Applicant for any reason, the Applicant shall forfeit the entire Earnest Money. Applicant and Landlord agree that the Earnest Money deposit represents a fair and reasonable estimate of the costs and damages that Landlord will sustain as a result of payment represents a liquidated damage for breach of promise by Applicant. Failure to provide application details requested in this application within 48 hours of initial submission may be considered, at Landlord/PIP/sfrent.net's discretion, as a revocation. Applicant furthere acknowledges that where a unit is available for immediate move-in, Applicant lease date will begin no later than twenty-four (24) hours from the time and date on which Applicant has been notified that Applicant's application has been approved.", included_in_report: false, field_width: "12"},
  { field_order: 200, name: "", field_type: "long_description", required: false, content_meta: "Applicant agrees that Applicant will participate in Lanlord's mandatory Electronic Funds Transfer (EFT) program for rent payment, and before taking possession of the premises will grant Landlord and/or his agent(s) the necessary authorization to enroll Applicant in the program.", included_in_report: false, field_width: "12"},
  { field_order: 201, name: "", field_type: "long_description", required: false, content_meta: "Applicant represents all information contained in this APPLICATION to be true and accurate and understands that owner/manager will rely upon said information when accepting this Application. Applicant hereby  authorizes the owner/manager and his employees and agents to verify said information and make independent investigations to determine Applicant's credit, financial and character standing, which will include a credit and criminal background check. Applicant hereby releases owner/manager, his employees and agents and any firm or person supplying them with information form any liability whatsoever concerning the release or use of this information and will hold them all harmless form any suit or reprisal whatsoever. All holders of any such information are hereby authorized to release any and all such information they may have concerning Applicant.", included_in_report: false, field_width: "12"},
  { field_order: 202, name: "[enter full name]", field_type: "text_field", required: true, content_meta: "", included_in_report: false, field_width: "12"},
  { field_order: 203, name: "By checking here and enterting your name below, I declare under penalty of perjury that the foregoing is true and correct", field_type: "agreement", required: true, content_meta: "", included_in_report: false, field_width: "12"},
  { field_order: 204, name: "Miscellaneous ", field_type: "small_header", required: false, content_meta: "", included_in_report: false, field_width: "12"},
  { field_order: 205, name: "Please upload any financial supporting documents if receiving financial aid or any other income", field_type: "short_description", required: false, content_meta: "", included_in_report: false, field_width: "12"},
  { field_order: 206, name: "File upload #1", field_type: "file_upload", required: false, content_meta: "", included_in_report: false, field_width: "12"},
  { field_order: 207, name: "File upload #2", field_type: "file_upload", required: false, content_meta: "", included_in_report: false, field_width: "12"},
  { field_order: 208, name: "File upload #3", field_type: "file_upload", required: false, content_meta: "", included_in_report: false, field_width: "12"},
  { field_order: 209, name: "File upload #4", field_type: "file_upload", required: false, content_meta: "", included_in_report: false, field_width: "12"},
  { field_order: 210, name: "Explanation", field_type: "text_area", required: false, content_meta: "", included_in_report: false, field_width: "12"},
  { field_order: 211, name: "Referral", field_type: "small_header", required: false, content_meta: "", included_in_report: false, field_width: "12"},
  { field_order: 212, name: "Please include referrals contact information(name,email, phone,address), if tenant include their building and unit #", field_type: "short_description", required: false, content_meta: "", included_in_report: false, field_width: "12"},
  { field_order: 213, name: "Referral information", field_type: "text_area", required: false, content_meta: "", included_in_report: false, field_width: "12"},
  ...
  { field_order: 112, name: "Please ensure you include a full months of paystubs in each attchement below", field_type: "short_description", required: false, content_meta: "", included_in_report: false, field_width: "12"},
  { field_order: 115, name: "Attach secondary Pay Stub Month 3", field_type: "file_upload", required: false, content_meta: "", included_in_report: false, field_width: "6"},
  { field_order: 126, name: "", field_type: "long_description", required: false, content_meta: "Claridge is a TCAC regulated propety. Per TCAC regulations we are not able to rent to full time students, except in the following circumstances", included_in_report: false, field_width: "12"},
  { field_order: 127, name: "Any member(s) of the household is married and is filing a joint tax return", field_type: "options_select", required: true, content_meta: "No,Yes", included_in_report: false, field_width: "12"},
  { field_order: 128, name: "if yes please attach most recent tax return", field_type: "file_upload", required: false, content_meta: "", included_in_report: false, field_width: "12"},
  { field_order: 129, name: "Currently receiving assistance under Title IV of the Social Security Act (AFDC, Cal WORKS, TANF not SSA/SSI)", field_type: "options_select", required: true, content_meta: "No,Yes", included_in_report: false, field_width: "12"},
  { field_order: 130, name: "if yes please attach AFDC, Cal WORKS, or TANF documents ", field_type: "file_upload", required: false, content_meta: "", included_in_report: false, field_width: "12"},
  { field_order: 131, name: "Recently exited the foster care system (and currently 18-24 years old)", field_type: "options_select", required: true, content_meta: "No,Yes", included_in_report: false, field_width: "12"},
  { field_order: 132, name: "if yes please attach documents from the foster care system", field_type: "file_upload", required: false, content_meta: "", included_in_report: false, field_width: "12"},
  { field_order: 133, name: "Single parent and neither the parent or child(ren) are claimed as a dependent on a third parties tax return", field_type: "options_select", required: true, content_meta: "No,Yes", included_in_report: false, field_width: "12"},
  { field_order: 134, name: "Enrolled in a job training program under the JTPA or WIA or under a similar Federal/State/Local law", field_type: "options_select", required: true, content_meta: "No,Yes", included_in_report: false, field_width: "12"},
  { field_order: 135, name: "If yes please attach most recent tax return", field_type: "file_upload", required: false, content_meta: "", included_in_report: false, field_width: "12"},
  { field_order: 136, name: "", field_type: "long_description", required: false, content_meta: "If you are a full time student and answered \"no\" to all of the above questions your application will be denied.\r\nRegistered students must provide a letter, on institution letterhead, confirming registration", included_in_report: false, field_width: "12"},
  { field_order: 146, name: "Additional Info", field_type: "field_group", required: false, content_meta: "", included_in_report: false, field_width: "12"},
  { field_order: 148, name: "401k", field_type: "options_select", required: true, content_meta: "No,Yes", included_in_report: false, field_width: "6"},
  { field_order: 149, name: "if yes please attach current 401k statement", field_type: "file_upload", required: false, content_meta: "", included_in_report: false, field_width: "6"},
  { field_order: 150, name: "403b", field_type: "options_select", required: true, content_meta: "No,Yes", included_in_report: false, field_width: "6"},
  { field_order: 151, name: "if yes please attach current 403b statement", field_type: "file_upload", required: false, content_meta: "", included_in_report: false, field_width: "6"},
  { field_order: 152, name: "ira", field_type: "options_select", required: true, content_meta: "No,Yes", included_in_report: false, field_width: "6"},
  { field_order: 153, name: "if yes please attach current IRA statement", field_type: "file_upload", required: false, content_meta: "", included_in_report: false, field_width: "6"},
  { field_order: 154, name: "Money Market Account", field_type: "options_select", required: true, content_meta: "No,Yes", included_in_report: false, field_width: "6"},
  { field_order: 155, name: "if yes please attach current money market statement", field_type: "file_upload", required: false, content_meta: "", included_in_report: false, field_width: "6"},
  { field_order: 156, name: "Certificate of Deposit", field_type: "options_select", required: true, content_meta: "No,Yes", included_in_report: false, field_width: "6"},
  { field_order: 157, name: "if yes please attach current CD statement", field_type: "file_upload", required: false, content_meta: "", included_in_report: false, field_width: "6"},
  { field_order: 158, name: "Stocks and Bonds Certificate", field_type: "options_select", required: true, content_meta: "No,Yes", included_in_report: false, field_width: "6"},
  { field_order: 159, name: "if yes please attach current stock and bond statement", field_type: "file_upload", required: false, content_meta: "", included_in_report: false, field_width: "6"},
  { field_order: 160, name: "Life insurance policy", field_type: "options_select", required: true, content_meta: "No,Yes", included_in_report: false, field_width: "6"},
  { field_order: 161, name: "if yes please attach current life insurance statement", field_type: "file_upload", required: false, content_meta: "", included_in_report: false, field_width: "6"},
  { field_order: 162, name: "Mortgage Notes ", field_type: "options_select", required: true, content_meta: "No,Yes", included_in_report: false, field_width: "6"},
  { field_order: 163, name: "if yes please attach current mortgage note statement", field_type: "file_upload", required: false, content_meta: "", included_in_report: false, field_width: "6"},
  { field_order: 164, name: "Sales Contracts", field_type: "options_select", required: true, content_meta: "No,Yes", included_in_report: false, field_width: "6"},
  { field_order: 165, name: "if yes please attach current sales contract statement", field_type: "file_upload", required: false, content_meta: "", included_in_report: false, field_width: "6"},
  { field_order: 166, name: "Alimony/Child Support", field_type: "options_select", required: true, content_meta: "No,Yes", included_in_report: false, field_width: "6"},
  { field_order: 167, name: "if yes please attach current alimony/child support statement", field_type: "file_upload", required: false, content_meta: "", included_in_report: false, field_width: "6"},
  { field_order: 168, name: "ssi", field_type: "options_select", required: true, content_meta: "No,Yes", included_in_report: false, field_width: "6"},
  { field_order: 169, name: "if yes please attach current SSI statement", field_type: "file_upload", required: false, content_meta: "", included_in_report: false, field_width: "6"},
  { field_order: 170, name: "Disability payment", field_type: "options_select", required: true, content_meta: "No,Yes", included_in_report: false, field_width: "6"},
  { field_order: 171, name: "if yes please attach current disability payment statement", field_type: "file_upload", required: false, content_meta: "", included_in_report: false, field_width: "6"},
  { field_order: 172, name: "Public assistance", field_type: "options_select", required: true, content_meta: "No,Yes", included_in_report: false, field_width: "6"},
  { field_order: 173, name: "if yes please attach current public assistance statement", field_type: "file_upload", required: false, content_meta: "", included_in_report: false, field_width: "6"},
  { field_order: 174, name: "Aid to Families with Dependent Children (AFDC)", field_type: "options_select", required: true, content_meta: "No,Yes", included_in_report: false, field_width: "6"},
  { field_order: 175, name: "if yes please attach current (AFDC) statement", field_type: "file_upload", required: false, content_meta: "", included_in_report: false, field_width: "6"},
  { field_order: 176, name: "Temporary Assistance for Needy Families (TANF)", field_type: "options_select", required: true, content_meta: "No,Yes", included_in_report: false, field_width: "6"},
  { field_order: 177, name: "if yes please attach current (tanf) statement", field_type: "file_upload", required: false, content_meta: "", included_in_report: false, field_width: "6"},
  { field_order: 178, name: "General Relief (GR)", field_type: "options_select", required: true, content_meta: "No,Yes", included_in_report: false, field_width: "6"},
  { field_order: 179, name: "if yes please attach current general relief statemente", field_type: "file_upload", required: false, content_meta: "", included_in_report: false, field_width: "6"},
  { field_order: 180, name: "Unemployment Benefits", field_type: "options_select", required: true, content_meta: "No,Yes", included_in_report: false, field_width: "6"},
  { field_order: 181, name: "if yes please attach current unemployment benefit statement", field_type: "file_upload", required: false, content_meta: "", included_in_report: false, field_width: "6"},
  { field_order: 182, name: "Are you self-employed(1099 employee)?", field_type: "options_select", required: true, content_meta: "No,Yes", included_in_report: false, field_width: "6"},
  { field_order: 183, name: "if yes please attach most recent copy of Income Tax Return", field_type: "file_upload", required: false, content_meta: "", included_in_report: false, field_width: "6"},
  { field_order: 147, name: "", field_type: "long_description", required: false, content_meta: "As the Claridge is a TCAC regulated property. TCAC requires us to collect the following Statements (current) from all assets helding, including but not limited to:", included_in_report: false, field_width: "12"},
  { field_order: 90, name: "Attach Pay Stub Month 4", field_type: "file_upload", required: false, content_meta: "", included_in_report: false, field_width: "6"},
  { field_order: 91, name: "Attach Pay Stub Month 5", field_type: "file_upload", required: false, content_meta: "", included_in_report: false, field_width: "6"},
  { field_order: 92, name: "Attach Pay Stub Month 6", field_type: "file_upload", required: false, content_meta: "", included_in_report: false, field_width: "6"},
  { field_order: 93, name: "Attach Pay Stub Month 7", field_type: "file_upload", required: false, content_meta: "", included_in_report: false, field_width: "6"},
  { field_order: 94, name: "Attach Pay Stub Month 8", field_type: "file_upload", required: false, content_meta: "", included_in_report: false, field_width: "6"},
  { field_order: 95, name: "Attach Pay Stub Month 9", field_type: "file_upload", required: false, content_meta: "", included_in_report: false, field_width: "6"},
  { field_order: 96, name: "Attach Pay Stub Month 10", field_type: "file_upload", required: false, content_meta: "", included_in_report: false, field_width: "6"},
  { field_order: 97, name: "Attach Pay Stub Month 11", field_type: "file_upload", required: false, content_meta: "", included_in_report: false, field_width: "6"},
  { field_order: 116, name: "Attach secondary Pay Stub Month 4", field_type: "file_upload", required: false, content_meta: "", included_in_report: false, field_width: "6"},
  { field_order: 98, name: "Attach Pay Stub Month 12", field_type: "file_upload", required: false, content_meta: "", included_in_report: false, field_width: "6"},
  { field_order: 117, name: "Attach secondary Pay Stub Month 5", field_type: "file_upload", required: false, content_meta: "", included_in_report: false, field_width: "6"},
  { field_order: 118, name: "Attach secondary Pay Stub Month 6", field_type: "file_upload", required: false, content_meta: "", included_in_report: false, field_width: "6"},
  { field_order: 119, name: "Attach secondary Pay Stub Month 7", field_type: "file_upload", required: false, content_meta: "", included_in_report: false, field_width: "6"},
  { field_order: 120, name: "Attach secondary Pay Stub Month 8", field_type: "file_upload", required: false, content_meta: "", included_in_report: false, field_width: "6"},
  { field_order: 121, name: "Attach secondary Pay Stub Month 9", field_type: "file_upload", required: false, content_meta: "", included_in_report: false, field_width: "6"},
  { field_order: 122, name: "Attach secondary Pay Stub Month 10", field_type: "file_upload", required: false, content_meta: "", included_in_report: false, field_width: "6"},
  { field_order: 123, name: "Attach secondary Pay Stub Month 11", field_type: "file_upload", required: false, content_meta: "", included_in_report: false, field_width: "6"},
  { field_order: 124, name: "Attach secondary Pay Stub Month 12", field_type: "file_upload", required: false, content_meta: "", included_in_report: false, field_width: "6"}
])
