class AttachmentsController < ApplicationController
  ...
  private
    ...
    def attachment_params
      params.require(:attachment).permit(:user_id, :attachable_id, :attachable_type, :description,:content_name, :filename, :url, :content_meta, :filename_cache, :remove_filename)
    end
end
